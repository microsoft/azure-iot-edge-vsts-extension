...
export declare class ToolRunner extends events.EventEmitter {
    ...
    private _getCommandString(options, noPrefix?);
    private _getSpawnFileName(options);
    private _getSpawnArgs(options);
    private _isCmdFile();
    private _windowsQuoteCmdArg(arg);
    private _uv_quote_cmd_arg(arg);
    private _cloneExecOptions(options);
    private _getSpawnOptions(options);
    private _getSpawnSyncOptions(options);
    /**
     * Add argument
